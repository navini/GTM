...
#data=np.loadtxt('S11LBP4-smoothed.txt')
#data=np.loadtxt('S11LDP4-smoothed.txt')
files = ['Data/S11LBP3.txt','Data/S11LBP4.txt','Data/S11LDP3.txt','Data/S11LDP4.txt','Data/S11LPP3.txt','Data/S11LPP4.txt',]
plt.figure(1)
