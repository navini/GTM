...
#data=np.loadtxt('S11LBP4-smoothed-smoothed.txt')
#data=np.loadtxt('S11LDP4-smoothed-smoothed.txt')
#files = ['Data/S11LBP3-smoothed.txt','Data/S11LBP4-smoothed.txt','Data/S11LDP3-smoothed.txt','Data/S11LDP4-smoothed.txt','Data/S11LPP3-smoothed.txt','Data/S11LPP4-smoothed.txt']
#for q in range(len(files)):
data1 = np.loadtxt('/s/chopin/a/grad/navinid/Dropbox/Research/gtm/python_GTM/Intersubject/Data/LBP3/S11LBP3-smoothed.txt')
data2 = np.loadtxt('/s/chopin/a/grad/navinid/Dropbox/Research/gtm/python_GTM/Intersubject/Data/LBP3/S16LBP3-smoothed.txt')
data = np.vstack((np.hstack((np.zeros(data1.shape),data1)),np.hstack((np.ones(data2.shape),data2))))
data_features = data[:,2:212]
data_classes = data[:,1:2]
data_subjects = data[:,0:1]
data_dim = 210
data_samples = data_features.shape[0]/2
...
plt.savefig('%s-vs-%s.jpg' % 'S11', 'S16')
plt.clf()
