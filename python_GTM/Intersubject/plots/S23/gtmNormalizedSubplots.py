...
#data=np.loadtxt('S23LBP4-smoothed.txt')
#data=np.loadtxt('S23LDP4-smoothed.txt')
files = ['Data/S23LBP3.txt','Data/S23LBP4.txt','Data/S23LDP3.txt','Data/S23LDP4.txt','Data/S23LPP3.txt','Data/S23LPP4.txt']
#plt.figure(1)
