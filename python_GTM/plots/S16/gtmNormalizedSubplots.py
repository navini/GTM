...
#data=np.loadtxt('S16LBP4-smoothed.txt')
#data=np.loadtxt('S16LDP4-smoothed.txt')
files = ['Data/S16LBP3.txt','Data/S16LBP4.txt','Data/S16LDP3.txt','Data/S16LDP4.txt','Data/S16LPP3.txt','Data/S16LPP4.txt']
#plt.figure(1)
