...
#data=np.loadtxt('S24LBP4-smoothed.txt')
#data=np.loadtxt('S24LDP4-smoothed.txt')
files = ['Data/S24LBP3.txt','Data/S24LBP4.txt','Data/S24LDP3.txt','Data/S24LDP4.txt','Data/S24LPP3.txt','Data/S24LPP4.txt']
#plt.figure(1)
