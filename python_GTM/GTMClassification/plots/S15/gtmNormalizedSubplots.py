...
#data=np.loadtxt('S15LBP4-smoothed.txt')
#data=np.loadtxt('S15LDP4-smoothed.txt')
files = ['Data/S15LBP3.txt','Data/S15LBP4.txt','Data/S15LDP3.txt','Data/S15LDP4.txt','Data/S15LPP3.txt','Data/S15LPP4.txt']
#plt.figure(1)
