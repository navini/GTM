...
#data=np.loadtxt('S20LBP4-smoothed.txt')
#data=np.loadtxt('S20LDP4-smoothed.txt')
files = ['Data/S20LBP3.txt','Data/S20LBP4.txt','Data/S20LDP3.txt','Data/S20LDP4.txt','Data/S20LPP3.txt','Data/S20LPP4.txt']
#plt.figure(1)
