...
#data=np.loadtxt('S13LBP4-smoothed.txt')
#data=np.loadtxt('S13LDP4-smoothed.txt')
files = ['Data/S13LBP3.txt','Data/S13LBP4.txt','Data/S13LDP3.txt','Data/S13LDP4.txt','Data/S13LPP3.txt','Data/S13LPP4.txt']
#plt.figure(1)
