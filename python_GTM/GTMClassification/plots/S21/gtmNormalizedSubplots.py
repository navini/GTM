...
#data=np.loadtxt('S21LBP4-smoothed.txt')
#data=np.loadtxt('S21LDP4-smoothed.txt')
files = ['Data/S21LBP3.txt','Data/S21LBP4.txt','Data/S21LDP3.txt','Data/S21LDP4.txt','Data/S21LPP3.txt','Data/S21LPP4.txt']
#plt.figure(1)
