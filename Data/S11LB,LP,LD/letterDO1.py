...
plt.axis('tight');
plt.title('EEG Signals of O1 channel with stimulus (Single-letter D Protocol)');
...
np.savetxt('S11LDCO1.txt', classData)
...
np.savetxt('S11LDO1-smoothed.txt', classData4smoothed)
