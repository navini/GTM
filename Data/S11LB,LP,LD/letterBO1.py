...
plt.plot(eeg[3000:4500,[6,8]]);  #  Stimulus and P4

plt.axis('tight');
plt.title('EEG Signals of O1 channel with stimulus (Single-letter B Protocol)');
...
np.savetxt('S11LBO1.txt', classData)
...
np.savetxt('S11LBO1-smoothed.txt', classData4smoothed)
'''
