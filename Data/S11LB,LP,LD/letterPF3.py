...
plt.axis('tight');
plt.title('EEG Signals of F3 channel with stimulus (Single-letter P Protocol)');
...
np.savetxt('S11LPF3.txt', classData)
...
np.savetxt('S11LPF3-smoothed.txt', classData4smoothed)
