...
plt.axis('tight');
plt.title('EEG Signals of C4 channel with stimulus (Single-letter D Protocol)');
...
np.savetxt('S11LDC4.txt', classData)
...
np.savetxt('S11LDC4-smoothed.txt', classData4smoothed)
