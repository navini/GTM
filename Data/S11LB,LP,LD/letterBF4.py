...
plt.plot(eeg[3000:4500,[1,8]]);  #  Stimulus and P4

plt.axis('tight');
plt.title('EEG Signals of F4 channel with stimulus (Single-letter B Protocol)');
...
np.savetxt('S11LBF4.txt', classData)
...
np.savetxt('S11LBF4-smoothed.txt', classData4smoothed)
'''
