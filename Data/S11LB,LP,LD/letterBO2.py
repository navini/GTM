...
plt.plot(eeg[3000:4500,[7,8]]);  #  Stimulus and P4

plt.axis('tight');
plt.title('EEG Signals of O2 channel with stimulus (Single-letter B Protocol)');
...
np.savetxt('S11LBO2.txt', classData)
...
np.savetxt('S11LBO2-smoothed.txt', classData4smoothed)
'''
