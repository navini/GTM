...
plt.axis('tight');
plt.title('EEG Signals of C3 channel with stimulus (Single-letter D Protocol)');
...
np.savetxt('S11LDC3.txt', classData)
...
np.savetxt('S11LDC3-smoothed.txt', classData4smoothed)
