...
plt.plot(eeg[3000:4500,[3,8]]);  #  Stimulus and P4

plt.axis('tight');
plt.title('EEG Signals of C4 channel with stimulus (Single-letter B Protocol)');
...
np.savetxt('S11LBC4.txt', classData)
...
np.savetxt('S11LBC4-smoothed.txt', classData4smoothed)
'''
