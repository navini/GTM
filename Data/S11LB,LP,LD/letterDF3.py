...
plt.axis('tight');
plt.title('EEG Signals of F3 channel with stimulus (Single-letter D Protocol)');
...
np.savetxt('S11LDF3.txt', classData)
...
np.savetxt('S11LDF3-smoothed.txt', classData4smoothed)
