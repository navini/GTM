...
plt.axis('tight');
plt.title('EEG Signals of F4 channel with stimulus (Single-letter D Protocol)');
...
np.savetxt('S11LDF4.txt', classData)
...
np.savetxt('S11LDF4-smoothed.txt', classData4smoothed)
