...
plt.axis('tight');
plt.title('EEG Signals of O2 channel with stimulus (Single-letter D Protocol)');
...
np.savetxt('S11LDCO2.txt', classData)
...
np.savetxt('S11LDO2-smoothed.txt', classData4smoothed)
