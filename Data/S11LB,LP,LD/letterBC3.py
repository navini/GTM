...
plt.plot(eeg[3000:4500,[2,8]]);  #  Stimulus and P4

plt.axis('tight');
plt.title('EEG Signals of C3 channel with stimulus (Single-letter B Protocol)');
...
np.savetxt('S11LBC3.txt', classData)
...
np.savetxt('S11LBC3-smoothed.txt', classData4smoothed)
'''
