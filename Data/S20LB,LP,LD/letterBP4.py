...
plt.axis('tight');
plt.title('EEG Signals of P4 channel with stimulus (Single-letter B Protocol)');
...
np.savetxt('S20LBP4.txt', classData)
...
np.savetxt('S20LBP4-smoothed.txt', classData4smoothed)
