...
plt.axis('tight');
plt.title('EEG Signals of P4 channel with stimulus (Single-letter P Protocol)');
...
np.savetxt('S24LPP4.txt', classData)
...
np.savetxt('S24LPP4-smoothed.txt', classData4smoothed)
