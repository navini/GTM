...
plt.axis('tight');
plt.title('EEG Signals of P3 channel with stimulus (Single-letter B Protocol)');
...
np.savetxt('S23LBP3.txt', classData)
...
np.savetxt('S23LBP3-smoothed.txt', classData4smoothed)
