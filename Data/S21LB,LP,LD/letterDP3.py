...
plt.axis('tight');
plt.title('EEG Signals of P3 channel with stimulus (Single-letter D Protocol)');
...
np.savetxt('S21LDP3.txt', classData)
...
np.savetxt('S21LDP3-smoothed.txt', classData4smoothed)
